...
# Leer el archivo .stl
print("Leyendo archivo STL...")
gmsh.model.add("model")
gmsh.merge(stl_file)
gmsh.model.geo.synchronize()

# Crear la superficie y el volumen desde el archivo STL
surfaces = gmsh.model.getEntities(dim=2)
surface_loop = gmsh.model.geo.addSurfaceLoop([s[1] for s in surfaces])
volume = gmsh.model.geo.addVolume([surface_loop])
gmsh.model.geo.synchronize()

# Asignar un grupo físico al volumen
group_id = gmsh.model.addPhysicalGroup(3, [volume])
gmsh.model.setPhysicalName(3, group_id, "Bone_Volume")

# Asignar un grupo físico a cada superficie
...
# Definir el tamaño de los elementos de la malla (más pequeño para una malla más fina)
element_size = 1  # Ajusta este valor para cambiar la finura de la malla
...
# Guardar la malla en un archivo .msh
gmsh.write("bone_mesh_1.5.msh")
print("Malla guardada en bone_mesh_1.5.msh")

# Convertir la malla de Gmsh a Dolfinx
x = gmshio.extract_geometry(gmsh.model)
topologies = gmshio.extract_topology_and_markers(gmsh.model)

# Procesar la topología y la información de celdas
...
# Ordenar elementos por dimensión ascendente
perm_sort = np.argsort(cell_dimensions)

# Obtener el ID de la celda de mayor dimensión y convertir la topología
...
# Crear MeshTags para las facetas
# Permutar facetas del orden MSH al orden DOLFINx
...
with XDMFFile(mesh.comm, "./26_06_24/fem_function_BVTV.xdmf", "w") as file:
...
with XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_modulo.xdmf", "w") as file_modulo, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_BVTV.xdmf", "w") as file_BVTV, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_vm.xdmf", "w") as file_array_vm, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_damage.xdmf", "w") as file_array_damage, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_alpha.xdmf", "w") as file_alpha, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_psi.xdmf", "w") as file_array_psi, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_array_error.xdmf", "w") as file_array_error, \
     XDMFFile(mesh.comm, "./26_06_24/fase_1/fem_function_densidad_fase_1.xdmf", "w") as file_densidad_aparente:
...
# ----------------------------------------------------------------------------------------------------
    with XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_2/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
# ----------------------------------------------------------------------------------------------------
    with XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_3/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
# ----------------------------------------------------------------------------------------------------
    with XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_4/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
# ----------------------------------------------------------------------------------------------------
    ...
    with XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_5/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
# ----------------------------------------------------------------------------------------------------
    with XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_51/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
    ...
    with XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_61/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
#-------------------------------------------------------------------------------------------
    with XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_7/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
    ...
    with XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_dot_vbr.xdmf", "w") as file_dot_vbr, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_densidad_material.xdmf", "w") as file_densidad_material, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_modulo.xdmf", "w") as file_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_BVTV.xdmf", "w") as file_BVTV, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_modulo.xdmf", "w") as file_array_modulo, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_vm.xdmf", "w") as file_array_vm, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_damage.xdmf", "w") as file_array_damage, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_alpha.xdmf", "w") as file_alpha, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_rdot.xdmf", "w") as file_array_rdot, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_psi.xdmf", "w") as file_array_psi, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_array_error.xdmf", "w") as file_array_error, \
         XDMFFile(mesh.comm, "./26_06_24/fase_71/fem_function_densidad_aparente.xdmf", "w") as file_densidad_aparente:
...
data.to_csv('./26_06_24/resultados_promedio_final.csv', index=False)
